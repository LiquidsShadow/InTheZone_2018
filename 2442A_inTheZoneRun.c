...
#pragma config(Motor,  port1,           leftPincer,    tmotorVex393_HBridge, openLoop)
#pragma config(Motor,  port2,           rightPincer,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           mobileBaseLiftRight, tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port10,          mobileBaseLiftLeft, tmotorNone, openLoop)
